    ...
    <div>
      <div className="w-full mx-auto min-w-0 dark:highlight-white/5">
        <div className="overflow-x-auto flex">
          {api.data?.map((anime) => {
            return (
              <div key={anime.mal_id} className="flex-none py-6 px-3 last:pr-4">
                <Link
              ...
              @endif */}
                  ...
                  <div className="absolute z-10 inset-x-0 bottom-0 h-36 bg-gradient-to-t from-black/80 duration-200 group-hover:from-black/75"></div>
                </Link>
              </div>
            );
          })}
